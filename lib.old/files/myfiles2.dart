...
class Myfiles2 extends StatefulWidget {
  ...
  const Myfiles2({Key? key, required this.type, required this.caseNumber})
      : super(key: key);
...
class _Myfiles2State extends State<Myfiles2> {
  ...
  late String type1;
  late String caseNumber1;

  @override
  void initState() {
    super.initState();
    type1 = widget.type;
    caseNumber1 = widget.caseNumber;
    fetchData();
  }
  ...
  void fetchData() async {
    ...
    if (type1 == '1') {
      caseSnapshot = await FirebaseFirestore.instance
          .collection('files')
      ...
      caseSnapshot = await FirebaseFirestore.instance
          .collection('files')
          .where('caseNo', isEqualTo: caseNumber1)
          .where('lawyer_uid', isEqualTo: lawyerId)
          .get();
    }
