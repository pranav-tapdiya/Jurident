...
class _NewsAppState extends State<NewsApp> {
  ...
  void initState() {
    super.initState();
    checkInternetConnectivity(); // Check internet connectivity before fetching news
    fetchNews();
  ...
  Future<void> fetchNews() async {
    ...
    final url =
        'https://newsapi.org/v2/everything?q=indian law&apiKey=$apiKey&page=$currentPage';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              article['description'] ?? '',
                              style: TextStyle(fontSize: 16,color: themeProvider.hamcontainer),
                            ),
                          ],
                        ),
                      ),
